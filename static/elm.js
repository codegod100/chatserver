...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{n: false, o: '', t: _List_Nil, u: $elm$core$Maybe$Nothing},
...
var $author$project$Main$SystemMessage = 0;
...
var $author$project$Main$Message = F3(
	function (messageType, text, clientId) {
		return {D: clientId, F: messageType, A: text};
	});
...
var $author$project$Main$ChatMessage = 1;
		...
		switch (msg.$) {
			...
			case 1:
				return $elm$core$String$isEmpty(
					$elm$core$String$trim(model.o)) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{o: ''}),
					$author$project$Main$sendMessage(model.o));
			case 2:
				...
				if (!_v1.$) {
					...
					var newClientId = function () {
						var _v2 = _Utils_Tuple2(message.F, model.u);
						if ((!_v2.a) && (_v2.b.$ === 1)) {
							var _v3 = _v2.a;
							var _v4 = _v2.b;
							return $author$project$Main$extractClientId(message.A);
						} else {
							return model.u;
						}
					}();
			...
			default:
				...
				var statusMessage = isConnected ? {D: $elm$core$Maybe$Nothing, F: 0, A: 'Connected to server'} : {D: $elm$core$Maybe$Nothing, F: 0, A: 'Disconnected from server'};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('connected', model.n),
								_Utils_Tuple2('disconnected', !model.n)
							]))
					]),
				_List_fromArray(
					[
...
var $author$project$Main$SendClicked = {$: 1};
			...
			[
				...
				_List_fromArray(
					[
						...
						(!model.n) || $elm$core$String$isEmpty(
...
var $author$project$Main$viewMessage = F2(
	function (myClientId, message) {
		...
		if (!_v0) {
			...
			var isOwn = function () {
				var _v2 = _Utils_Tuple2(myClientId, message.D);
				if ((!_v2.a.$) && (!_v2.b.$)) {
					var myId = _v2.a.a;
					var msgId = _v2.b.a;
...
var $author$project$Main$viewMessages = function (model) {
	return A2(
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$viewMessage(model.u),
			model.t));
};
